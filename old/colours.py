...
class ColoursCog(commands.Cog, name="Colours"):
    ...
    def __init__(self, bot):
        ...
        self.bot.colours, self.bot.coloursrgb, self.bot.coloursdict = (
            self.defaultcolours()
        )
    ...
    async def addpcolour(self, ctx, guildid, tag, emoji, rgb, *, name):
        ...
        try:
            ...
            if len(rgbformatted) != 4:
                raise Exception("no")
        except Exception as e:
            return await ctx.send(
                "Not correct rgb formatting - type `R,G,B` (not `(R, G, B)`)"
            )

        if emoji.lower() in ["generate", "gen"]:
            img = await self.bot.loop.run_in_executor(
                None, self.image.colouremoji, self, rgbformatted
            )
    ...
    async def generateemoji(self, ctx, code, *rgb):
        ...
        if len(code) != 4:
            return await ctx.send(f"The code must be 4 letters long")

        img = await self.bot.loop.run_in_executor(
            None, self.image.colouremoji, self, rgb
        )
    ...
    async def servertest(self, ctx):
        ...
        async for m in channel.history(limit=None):
            ...
            if m.author.id == 420675394224521240:
                ...
                f = e.fields[0]
                if int(f.value) > 4000:
                    print(f"{e.author.emoji_name} - {f.value}")
    ...
    #         "emoji_name": "Marvel Red",
    #         "tag": "mrvl",
    #         "emojiId": "pl_mrvl:572564652559564810",
    #         "guild": 281648235557421056,
    #         "rgb": (234, 35, 40, 255),
    #     },
    #     272885620769161216: { # Blob Emoji
    #         "emoji_name": "Blob Yellow",
    #         "tag": "blob",
    #         "emojiId": "pl_blob:573101758130421770",
    #         "guild": 272885620769161216,
    #         "rgb": (252, 194, 27, 255),
    #     },
    #     316720611453829121: { # N.I.T.R.O.
    #         "emoji_name": "N.I.T.R.O. Orange",
    #         "tag": "ntro",
    #         "emojiId": "pl_ntro:575279584820330498",
    #         "guild": 316720611453829121,
    #         "rgb": (252, 150, 75, 255)
    #     },
    #     152517096104919042: { # Rocket League
    #         "emoji_name": "Rocketeer Blue",
    #         "tag": "rckt",
    #         "emojiId": "pl_rckt:574086064671555624",
    #         "guild": 152517096104919042,
    #         "rgb": (0, 156, 222, 255),
    #     },
    #     290572012437372931: { # Ping and Salar
    #         "emoji_name": "Ping and Salar's Red",
    #         "tag": "pgsl",
    #         "emojiId": "pl_pgsl:574086064827007027",
    #         "guild": 290572012437372931,
    #         "rgb": (255, 64, 0, 255),
    #     },
    #     349243932447604736: { # r/Jailbreak
    #         "emoji_name": "Cydia Brown",
    #         "tag": "jlbr",
    #         "emojiId": "pl_jlbr:574086064923475988",
    #         "guild": 349243932447604736,
    #         "rgb": (165, 107, 77, 255),
    #     },
    #     173184118492889089: { # Tatsumaki
    #         "emoji_name": "Tatsu Emerald",
    #         "tag": "ttsu",
    #         "emojiId": "pl_ttsu:574907457995014154",
    #         "guild": 173184118492889089,
    #         "rgb": (23, 161, 103, 255),
    #     },
    #     262077211526299648: { # Auttaja
    #         "emoji_name": "Auttaja Blue",
    #         "tag": "attj",
    #         "emojiId": "pl_attj:574907457915060224",
    #         "guild": 262077211526299648,
    #         "rgb": (0, 112, 250, 255),
    #     },
    #     228406572756369408: { # r/StarWars
    #         "emoji_name": "Opening Crawl Yellow",
    #         "tag": "stwr",
    #         "emojiId": "pl_stwr:575279585130840102",
    #         "guild": 228406572756369408,
    #         "rgb": (254, 210, 24, 255),
    #     },
    #     145166056812576768: { # Ayana
    #         "emoji_name": "Ayana Pink",
    #         "tag": "ayna",
    #         "emojiId": "pl_ayna:575452605292216340",
    #         "guild": 145166056812576768,
    #         "rgb": (198, 59, 104, 255),
    #     },
    #     284447205358829570: { # The Furry Nexus
    #         "emoji_name": "Paw Print Pink",
    #         "tag": "frry",
    #         "emojiId": "pl_frry:575567782683607040",
    #         "guild": 284447205358829570,
    #         "rgb": (198, 118, 255, 255)
    #     },
    #     304383757975289857: { # Blob Hub
    #         "emoji_name": "Butterfly Pink",
    #         "tag": "nbhb",
    #         "emojiId": "pl_nbhb:575636279383949312",
    #         "guild": 304383757975289857,
    #         "rgb": (233, 160, 214, 255),
    #     },
    #     416749164731301888: { # PUBG
    #         "emoji_name": "Winner Winner Golden Dinner",
    #         "tag": "pubg",
    #         "emojiId": "pl_pubg:575808438114844682",
    #         "guild": 416749164731301888,
    #         "rgb": (222, 141, 0, 255)
    #     },
    #     478114566509821953: { # r/Google
    #         "emoji_name": "Google Yellow",
    #         "tag": "goog",
    #         "emojiId": "pl_goog:576591834529267732",
    ...
    #         "emoji_name": "Pepe Green",
    #         "tag": "pepe",
    #         "emojiId": "pl_pepe:577471090973212683",
    #         "guild": 493351982887862283,
    #         "rgb": (91, 144, 66, 255),
    #     },
    #     446658603873730611: { # Raft
    #         "emoji_name": "Raft Blue",
    #         "tag": "raft",
    #         "emojiId": "pl_raft:577597652573749248",
